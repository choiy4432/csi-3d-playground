...
import { Card, Field, SaveBar, S, btn } from '../shared.jsx'
  ...
  return (
    <>
      <Card title="시나리오 기본 정보">
        ...
        <Field label="기본 난이도" hint="플레이어가 선택하지 않을 때의 기본값">
          <select
            style={S.select}
      ...
      <Card title="난이도 파라미터 (CONFIG)">
        <table style={S.table}>
          <thead>
            <tr>
              <th style={S.th}>grade_band</th>
              <th style={S.th}>대상</th>
              <th style={S.th}>훼손율 (%)</th>
